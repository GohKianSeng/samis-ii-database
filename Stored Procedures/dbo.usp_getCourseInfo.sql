...
SELECT LastRegistrationDate, AdditionalQuestion, Fee, CourseDay, courseID, CourseName, CourseStartDate, CourseStartTime, CourseEndTime, E.AreaName AS courseLocation, dbo.udf_getStafforMemberName(A.CourseInCharge) AS Name, A.CourseInCharge FROM dbo.tb_course AS A
